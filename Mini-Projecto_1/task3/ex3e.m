...
p = 60;         % Maximum queue occupation percentage for data packets
...
title('Average Packet Delay for Data and VoIP with 60% Queue Occupation Limit');
legend('Data', 'VoIP');
hold off;
...
xlabel('Number of VoIP Flows');
ylabel('Packet Loss (%)');
title('Packet Loss for Data and VoIP with 60% Queue Occupation Limit');
legend('Data', 'VoIP');
hold off;